...
import com.truemind.pensionnleisure.util.CustomDatePickerDialog;
...
public class SpecActivity extends Activity {
    ...
    public void setFontToViewImpact(TextView... views) {
        Typeface NanumNormal = Typeface.createFromAsset(this.getAssets(), "impact.ttf");
